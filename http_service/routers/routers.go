...
import (
	// alicerouters "go_learn/http_service/routers/alice_routers"
	// noderouters "go_learn/http_service/routers/node_routers"
	// smithrouters "go_learn/http_service/routers/smith_routers"
	// webhookrouters "go_learn/http_service/routers/webhook_routers"

	// "log"

	miniorouters "go_learn/http_service/routers/minio_routers"
...
func RegisterRoutes(router *gin.RouterGroup) {
	...
	miniorouters.RegisterRoutes(router)
